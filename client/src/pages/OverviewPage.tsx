    ...
    <div className="p-6 md:p-8 max-w-5xl">
      <div className="mb-10">
        ...
        <p className="text-muted-foreground mt-3 max-w-lg text-sm leading-relaxed">
          Salary management for your organisation. Manage employees, analyse
          compensation data, and make data-driven pay decisions.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
        ...
        >
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            Add, edit, search, and filter your workforce. Export and manage
        ...
        >
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            Explore compensation data by country, department, and job title.
            View percentile breakdowns.
          </p>
        </button>
      </div>
      ...
      <div className="text-muted-foreground">
        ...
        <ul className="space-y-2 text-sm">
          <li className="flex items-start gap-2">
            ...
            Go to <strong className="text-foreground">Employees</strong> to add,
            edit, or remove team members
          </li>
          <li className="flex items-start gap-2">
            <span className="text-primary mt-0.5">→</span>
            Use <strong className="text-foreground">Insights</strong> to explore
            salary distribution by country, job title, and department
          </li>
          <li className="flex items-start gap-2">
            <span className="text-primary mt-0.5">→</span>
